...
class LightGCN(GraphRecommender):
    ...
    def train(self):
        ...
        torch.save(self.user_emb, 'C:\\Users\\23386\\PycharmProjects\\rec\\emb\\user_embeddings_LightGCN_book.pt')
        torch.save(self.item_emb, 'C:\\Users\\23386\\PycharmProjects\\rec\\emb\\item_embeddings_LightGCN_book.pt')
        ...
        sns.kdeplot(x=[p[0] for p in item_emb_2d], y=[p[1] for p in item_emb_2d], bw_adjust=0.5, fill=True,
                    cmap="coolwarm",
                    ax=axs[0])
        axs[0].set_title(f'2D KDE of LightGCN', fontsize=12, fontweight="bold")
        # 提取数据点的坐标，用于计算角度
        ...
        axs[1].set_title(f'Angle KDE of LightGCN', fontsize=12)
