...
class AUPlus(GraphRecommender):
    def __init__(self, conf, training_set, test_set):
        ...
        self.save_path = f'./results/AUPlus-lamb{self.cl_rate}-eps{self.eps}-nlayer{self.n_layers}-temp{self.temp}-gamma{self.gamma}-bpr{self.bpr}-mode{self.mode}-gammap{self.gammap}.pt'
