...
def load_log(args, model_name):
    ...
    if not os.path.exists('./log/'+model_name):
        os.mkdir('C:/Users/23386/PycharmProjects/rec/SUAU/log/' + model_name)
    if not os.path.exists('C:/Users/23386/PycharmProjects/rec/SUAU/log/'+model_name+'/'+args.dataset):
        os.mkdir('C:/Users/23386/PycharmProjects/rec/SUAU/log/'+model_name+'/'+args.dataset)
    timestamp = datetime.now().strftime("%m%d_%H%M")
    if args.log == 'None':
        logfile = os.path.join('C:/Users/23386/PycharmProjects/rec/SUAU/log/'+model_name+'/'+args.dataset, f'{timestamp}.log')
    else:
        logstr = str(args.log)
        logfile = os.path.join('C:/Users/23386/PycharmProjects/rec/SUAU/log/'+model_name+'/'+args.dataset, f'{logstr}.log')
